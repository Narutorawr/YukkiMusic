...
API_ID = int(getenv("API_ID", "27365066"))
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "827203629").split())
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/namikazekelra"
)  # Example:- https://t.me/TheTeamVivek
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/namikazekelra"
